...
```
/
├── Table.jsx                    # Основной компонент таблицы
├── index.js                     # Публичное API
├── components/
│   ├── TableHeader.jsx          # Компонент заголовка таблицы
│   └── FiltersPanel.jsx         # Панель фильтров
├── hooks/
│   ├── useTableLogic.js         # Хук для логики таблицы
│   └── useNodeVisibility.js     # Хук для управления видимостью узлов
├── utils/
│   ├── dateUtils.js             # Утилиты для работы с датами
│   ├── dataProcessing.js        # Обработка данных и провайдеры
│   └── performanceUtils.js      # Утилиты для производительности
└── data/
    └── defaultData.js           # Данные по умолчанию
```
