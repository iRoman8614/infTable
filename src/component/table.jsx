 ...
 */
export const Table = ({maxWidth, maxHeight}) => {
    ...
    return (
        ...
        >
            <table style={{ width: '100%', borderCollapse: 'collapse', border: 'none' }}>
                <thead style={{ position: 'sticky', top: 0, background: getStageColor("BGHeader"), zIndex: 10 }}>
                <tr>
                    <th rowSpan="2" style={{
                        padding: '2px'
                    }}>Дата</th>
                ...
                {dates.map((dateString, index) => {
                    ...
                    return (
                        <tr
                            ...
                            style={{
                                height: `${rowHeight}px`,
                                backgroundColor: getStageColor("DATE", isPastDate)
                            }}
                        >
