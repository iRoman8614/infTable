...
//
// /**
//  * VIRTUALIZED TABLE COMPONENT с оптимизированной загрузкой заголовков
//  */
// export const Table = ({
//                           maxWidth = '100%',
//                           maxHeight = '600px',
...
//
//     // Async обработчик клика по ячейке (мемоизирован)
...
//                 };
//
//                 // Проверяем, является ли обработчик async функцией
...
//                         await window.onTableCellClick(cellData);
//                     } else {
...
//                                             rowSpan={rowSpan}
//                                             onClick={onCellClick || window?.onTableCellClick ? (event) => handleCellClick(dateString, leafNode.id, cellValue, event) : undefined}
//                                             style={{
//                                                 padding: '4px',
//                                                 textAlign: 'center',
...
//                                                 borderRight: '1px solid #ddd',
//                                                 fontWeight: 'normal',
//                                                 cursor: (onCellClick || window?.onTableCellClick) ? 'pointer' : 'default',
//                                                 userSelect: 'none',
...
//                     <span><strong>Логика направлений:</strong> UP/DOWN</span>
//                 </div>
//             )}
//         </>
//     );
...
const useGlobalClickHandlers = () => {
    ...
    useEffect(() => {
        ...
        if (typeof window !== 'undefined') {
            ...
            // Отслеживаем изменения в window
            const observer = new MutationObserver(handleWindowChange);
...
/**
 * VIRTUALIZED TABLE COMPONENT с исправленным onTableCellClick
 */
export const Table = ({
                          maxWidth = '100%',
                          maxHeight = '600px',
    ...
    // Async обработчик клика по ячейке (улучшенный)
    const handleCellClick = useCallback(async (date, nodeId, cellValue, event) => {
        const clickKey = `${date}-${nodeId}`;
