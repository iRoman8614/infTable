...
// src/component/Table/data/headers.js
// Экспорт заголовков в глобальный объект window
...
// Также экспортируем для модульных систем
if (typeof module !== 'undefined' && module.exports) {
    module.exports = window.Headers;
}

console.log('[Headers] Заголовки загружены в window.Headers:', window.Headers.headers.length, 'узлов');