...
//     //
//     //         // Если есть заголовки, но нет реального dataProvider, используем пустой
//     //         if (headerProvider) {
//     //             console.log('[WebTableWrapper] Заголовки готовы, инициализируем таблицу (данные могут быть пустыми)');
//     //             setIsReady(true);
//     //
//     //             // Обновляем глобальное состояние только если провайдеры изменились
//     //             if (typeof window !== 'undefined' && window.VirtualizedTableState) {
//     //                 // Всегда гарантируем наличие dataProvider (реальный или пустой)
...
//     //             }
//     //         } else {
//     //             console.log('[WebTableWrapper] Провайдер заголовков не найден, повторная проверка через 1000мс');
...
//     //     }
//     //
//     //     // Cleanup при размонтировании - сбрасываем готовность
//     //     return () => {
//     //         console.log('[WebTableWrapper] Компонент размонтируется, сбрасываем готовность');
//     //         setIsReady(false);
//     //     };
...
//         if (isReady) {
//             console.log('[WebTableWrapper] Уже инициализирован, пропускаем');
//             return;
//         }
//
//         let retryTimer = null;
...
//             const headerProvider = getHeaderProvider();
//
//             // Если есть заголовки, инициализируем
//             if (headerProvider) {
...
//                 }
//
//                 // Обновляем глобальное состояние ОДИН РАЗ
//                 if (typeof window !== 'undefined' && window.VirtualizedTableState) {
//                     if (!window.VirtualizedTableState.dataProvider) {
//                         window.VirtualizedTableState.dataProvider = dataProvider || emptyProviderRef.current;
...
//                 }
//             } else {
//                 console.log('[WebTableWrapper] ⏳ Провайдер заголовков не найден, повторная проверка через 500мс');
//                 retryTimer = setTimeout(initializeWithRetry, 500);
//             }
//         };
//
...
//         initializeWithRetry();
//
//         // Резервный интервал проверки (только если не готов)
...
//             // НЕ сбрасываем isReady при размонтировании!
//         };
//     }, []);
//
